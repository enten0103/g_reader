#pragma once
#ifndef __GCLIENT_H__
#define __GCLIENT_H__
...
extern "C" {
	...
	typedef void(*delegateOnRemoteConnected)(char* readerName, HANDLE handleSocket);
	...
	GClient* __stdcall OpenRS232(const char* readerName, int timeout);
	GClient* __stdcall OpenRS485(const char* readerName, int timeout);
	GClient* __stdcall OpenTcpClient(const char* readerName, int timeout);
	int __stdcall GetAttachedUsbHid(std::vector<std::string>* devs_path);
	GClient* __stdcall OpenUSBHID(const char* readerName, int timeout);
	void __stdcall RegCallBack(GClient* client, Callback_Type type, void* call);
	void __stdcall SendSynMsgTimeout(GClient* client, MESSAGE type, void* msg, int timeout);
	void __stdcall SendSynMsg(GClient* client, MESSAGE type, void* msg);
	void __stdcall SendSynMsgTimeoutRetry(GClient* client, MESSAGE type, void* msg, int timeout, int retry);
	void __stdcall SendUnSynMsg(GClient* client, MESSAGE type, void* msg);
	void __stdcall SendUnSynMsgTimeoutRetry(GClient* client, MESSAGE type, void* msg, int retry);
